...
$args['menu_title'] = __('ViewPoint Options', 'nhp-opts');

//Custom Page Title for options page - default is "Options"
$args['page_title'] = __('ViewPoint Theme Options', 'nhp-opts');

//Custom page slug for options page (wp-admin/themes.php?page=***) - default is "nhp_theme_options"
$args['page_slug'] = 'viewpoint_options';
...
$sections[] = array(
				...
				'fields' => array(
					array(
						...
						'type' => 'text',
						'title' => 'Logo letter',
						'sub_desc' => 'This is the letter that shows up between the menus',
						'std' => 'P'
						),
					array(
						'id' => 'favicon',
					...
					array(
						...
						'std' => 'The Force is strong with this one'
						),
					array(
						...
						'std' => 'In my experience, there is no such thing as luck. <br /> I must face him, alone.'
						),
					array(
						'id' => 'phone',
						'type' => 'text',
