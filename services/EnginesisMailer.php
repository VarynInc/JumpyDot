...
//
require_once($_SERVER['DOCUMENT_ROOT'] . '/procs/common.php');
require $_SERVER['DOCUMENT_ROOT'] . '/procs/phpmailer/PHPMailerAutoload.php';
...
class EnginesisMailer
{
	...
	public function send () {
        ...
        $mailConfig = $_MAIL_HOSTS[$serverStage];
        if ($this->m_status == '') {
